export default function LeadRecordCard({
  selectedObj,
  handleRecordClick,
  handleOpenModal,
  sortingFilter,
          ...
          >
            <div className='record-card__title'>
              <div className='record-card__title-wrapper'>
                <div className='record-card__title--contact'>
                  {record.contactName}
                </div>
                <div className='record-card__title--company'>
                  {record.companyName}
                </div>
              </div>
            ...
            <div className='record-card__summary'>
              ...
              <div>{record.productInterest}</div>
            </div>
